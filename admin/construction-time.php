<?php
    ...
    && isset($_POST['work_time'])) {
      ...
      $query = "INSERT into construction_time (place, date, time)
    ...
    $query= "SELECT * FROM construction_time ORDER BY ID desc";
    ...
    # Svarat was clicked
      if(isset($_POST["id"])) {
        ...
        $query = "UPDATE construction_time SET marked = 'marked' WHERE id = $id";
    ...
    # Avmarkera was clicked
      if(isset($_POST["id"])) {
        $id = mysqli_real_escape_string($conn, $_POST['id']);
        $query = "UPDATE construction_time SET marked = 'xxx' WHERE id = $id";
        mysqli_query($conn, $query);
    ...
    if(isset($_POST["id"]) && isset($_POST["id_delete"])) {
      ...
      $query = "DELETE FROM construction_time WHERE id = $id_delete";
      mysqli_query($conn, $query);
