<?php
    ...
    && isset($_POST['work_time'])) {
      ...
      $query = "INSERT into economy_time (place, date, time)
    ...
    # Svarat was clicked
      if(isset($_POST["id"])) {
        ...
        $query = "UPDATE economy_time SET marked = 'marked' WHERE id = $id";
    ...
    # Avmarkera was clicked
      if(isset($_POST["id"])) {
        $id = mysqli_real_escape_string($conn, $_POST['id']);
        $query = "UPDATE economy_time SET marked = 'xxx' WHERE id = $id";
        mysqli_query($conn, $query);
    ...
    if(isset($_POST["id"]) && isset($_POST["id_delete"])) {
      ...
      $query = "DELETE FROM economy_time WHERE id = $id_delete";
      mysqli_query($conn, $query);
