<?php
    ...
    && isset($_POST['work_time'])) {
      ...
      $query = "INSERT into restaurant_time (place, date, time)
    ...
    # Svarat was clicked
      if(isset($_POST["id"])) {
        ...
        $query = "UPDATE restaurant_time SET marked = 'marked' WHERE id = $id";
    ...
    # Avmarkera was clicked
      if(isset($_POST["id"])) {
        $id = mysqli_real_escape_string($conn, $_POST['id']);
        $query = "UPDATE restaurant_time SET marked = 'xxx' WHERE id = $id";
        mysqli_query($conn, $query);
    ...
    if(isset($_POST["id"]) && isset($_POST["id_delete"])) {
      ...
      $query = "DELETE FROM restaurant_time WHERE id = $id_delete";
      mysqli_query($conn, $query);
    ...
    echo "<h2>Arbetstider Hotell & Restaurang</h2>";
